          ...
          <tbody>
            ...
            <tr>
              <td style="text-align: center;"><?php if ($template['selected']) { ?>
                ...
                <?php } ?></td>
              <td class="left"><?php echo ucfirst($template['name']); ?></td>
			   <td class="left"><?php echo $template['status']; ?></td>
              <td class="right"><?php foreach ($template['action'] as $action) { ?>
                [ <a href="<?php echo $action['href']; ?>" <?php echo (isset($action['target']))?'target="_blank"':'';?> ><?php echo $action['text']; ?></a> ]
                <?php } ?></td>
            </tr>
            <?php } ?>
            <?php } else { ?>
